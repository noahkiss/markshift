...
export const mdToHtmlCommand = new Command('md-to-html')
  ...
  .action(async (input, options, command) => {
    ...
    try {
      ...
      const converter = new MarkdownToHtmlConverter(getUserConfig()?.markdownToHtml);
